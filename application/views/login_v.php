...
<head>
    ...
    <link
        href="<?php echo base_url();?>assets2/https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
                                    ...
                                    <form method="post" action="<?php echo base_url('login/proses_login') ?>" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Enter Your Password" name="password">
                                        </div>
                                        ...
                                        <!-- <hr>
                                        <a href="<?php echo base_url();?>assets2/index.html" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Login with Google
                                        </a>
                                        <a href="<?php echo base_url();?>assets2/index.html" class="btn btn-facebook btn-user btn-block">
